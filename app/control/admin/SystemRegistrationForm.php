...
class SystemRegistrationForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $this->form->setFormTitle('Crie sua conta!');
        ...
        $this->form->addAction( 'Cadastrar',  new TAction([$this, 'onSave']), 'fas:check')->{'class'} = 'btn btn-sm btn-success';
      //  $this->form->addAction( _t('Clear'), new TAction([$this, 'onClear']), 'fa:eraser red' );
        ...
        $this->form->addFields( [new TLabel(Utils::spanRequired()._t('Name'), )],     [$name] );
        $this->form->addFields( [new TLabel(Utils::spanRequired()._t('Email'), )],    [$email] );
        $this->form->addFields( [new TLabel(Utils::spanRequired()._t('Password'), )], [$password] );
        $this->form->addFields( [new TLabel(Utils::spanRequired()._t('Password confirmation'), )], [$repassword] );
    ...
    public static function onSave($param)
    {
        try
        {
            ...
            $object->active = 'Y';
            $object->flag_candidato = 1;
            $object->data_registro = date('Y-m-d H:i');
