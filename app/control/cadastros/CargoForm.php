...
class CargoForm extends BasePage
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de Cargos");
        ...
        $this->addBotaoVoltar('CargoList');
        // vertical box container
        $container = new TVBox;
        $container->style = 'width: 100%';
        $container->class = 'form-container';
        $container->add(TBreadCrumb::create(["Cadastros","Cargos"]));
