...
class UfList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de UFs");
        ...
        $row1 = $this->form->addFields([new TLabel("Sigla:", null, '14px', null)],[$sigla]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['UfForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $container->add(TBreadCrumb::create(["Cadastros","UFs"]));
