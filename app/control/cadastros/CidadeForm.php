...
class CidadeForm extends BasePage
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        $row2 = $this->form->addFields([new TLabel("UF:", null, '14px', null)],[$uf_id]);
        $row3 = $this->form->addFields([new TLabel("Código IBGE:", null, '14px', null)],[$codigo_ibge]);
        ...
        $this->addBotaoVoltar('CidadeList');
